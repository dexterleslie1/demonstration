...
public class FragmentListByUserId extends MyBaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_list_by_user_id, container, false);

        sharedPreferencesSupport = new SharedPreferencesSupport(getActivity());

        ListViewListByUserIdAdapter listViewAdapter = new ListViewListByUserIdAdapter(getActivity());
        ListView listView = view.findViewById(R.id.listViewListByUserId);
        listView.setAdapter(listViewAdapter);

        // 初始化状态 Spinner
        Spinner spinner = view.findViewById(R.id.spinnerListByUserId);
        ...
        Button buttonListByUserIdQuery = view.findViewById(R.id.buttonListByUserIdQuery);
        buttonListByUserIdQuery.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(status)) {
                    call = RetrofitClient.getApiService().listByUserIdAndWithoutStatus(userId, true);
                } else {
                    call = RetrofitClient.getApiService().listByUserIdAndStatus(userId, true, status);
                }
