...
//    public DefaultMQPushConsumer consumer(Map<Integer, Integer> batchSizeToCountMap) throws MQClientException {
//        // 创建消费者实例，并设置消费者组名
...
////        consumer.setAdjustThreadPoolNumsThreshold(999999999);
...
////            if (msgs.size() >= 900) {
//            a.incrementAndGet();
//            log.info("concurrent:" + a.get() + ",size:" + msgs.size());
////            }
//
...
//                    if (!batchSizeToCountMap.containsKey(batchSize)) {
//                        batchSizeToCountMap.put(batchSize, 0);
//                    }
//                    batchSizeToCountMap.put(batchSize, this.batchSizeToCountMap().get(batchSize) + 1);
//                }
//
////                if (msgs.size() >= 900) {
//                a.decrementAndGet();
