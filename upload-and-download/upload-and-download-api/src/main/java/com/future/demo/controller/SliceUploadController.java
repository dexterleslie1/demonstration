...
//// 分片上传
//@RestController
//@RequestMapping(value="/api/v1/slice")
//@Slf4j
//public class SliceUploadController {
//    // 判断分片是否已上传
//    @GetMapping("exists")
//    public ObjectResponse<SliceVO> exists(@RequestBody(required = false) SliceVO sliceVO) throws BusinessException {
//
//        if(sliceVO==null) {
...
//            File temporaryFile = new File(temporaryDirectory, sliceFileName);
...
//    public ObjectResponse<String> upload(@RequestParam(value = "fileMd5", defaultValue = "") String fileMd5,
...
//        File fileSlice = new File(temporaryDirectory, filename);
...
//    public ObjectResponse<String> merge(@RequestBody(required = false) SliceVO sliceVO) throws IOException {
//        if(sliceVO==null) {
//            throw new IllegalArgumentException("没有指定sliceVO参数");
//        }
//
...
//
//        // 合并分片
//        File targetFile = new File(temporaryDirectory, fileMd5);
