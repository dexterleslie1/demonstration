...
import (
	...
	cnatv1alpha1 "demo-client-go-code-generator-cnat/pkg/apis/cnat/v1alpha1"
	clientset "demo-client-go-code-generator-cnat/pkg/generated/clientset/versioned"
	cnatscheme "demo-client-go-code-generator-cnat/pkg/generated/clientset/versioned/scheme"
	informers "demo-client-go-code-generator-cnat/pkg/generated/informers/externalversions/cnat/v1alpha1"
	listers "demo-client-go-code-generator-cnat/pkg/generated/listers/cnat/v1alpha1"
)
...
func (c *Controller) syncHandler(key string) (time.Duration, error) {
	...
	if !reflect.DeepEqual(original, instance) {
		...
		_, err = c.cnatClientset.CnatV1alpha1().Ats(instance.Namespace).UpdateStatus(context.Background(), instance, metav1.UpdateOptions{})
		if err != nil {
			return time.Duration(0), err
		}
	}
