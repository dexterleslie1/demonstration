...
import (
	...
	cnatscheme "demo-client-go-code-generator-website/pkg/generated/clientset/versioned/scheme"
	informers "demo-client-go-code-generator-website/pkg/generated/informers/externalversions/extensions.example.com/v1"
	listers "demo-client-go-code-generator-website/pkg/generated/listers/extensions.example.com/v1"
)
...
func NewController(
	kubeClientset kubernetes.Interface,
	cnatClientset clientset.Interface,
	websiteInformer informers.WebsiteInformer,
...
func (c *Controller) Run(threadiness int, stopCh <-chan struct{}) error {
	...
	if ok := cache.WaitForCacheSync(stopCh, c.websiteSynced); !ok {
...
func (c *Controller) syncHandler(key string) (time.Duration, error) {
	klog.Infof("=== Reconciling Website %s", key)
	...
	//original, err := c.websiteLister.Websites(namespace).Get(name)
	//if err != nil {
...
//		}
//
//		at, err := c.websiteLister.Ats(pod.GetNamespace()).Get(ownerRef.Name)
//		if err != nil {
