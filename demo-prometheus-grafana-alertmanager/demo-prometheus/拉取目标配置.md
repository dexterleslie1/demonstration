...
>> 注意：没有做实验验证。
>
>> 拉取目标的配置参考[链接](https://github.com/dexterleslie1/demonstration/blob/master/demo-prometheus-grafana-alertmanager/demo-docker-compose-prometheus-grafana-alertmanager/prometheus.yml)
>
