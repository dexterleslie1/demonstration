...
spring.shardingsphere.datasource.ds1.type=com.zaxxer.hikari.HikariDataSource
# 设置 Hikari 连接池
spring.shardingsphere.datasource.ds1.maximum-pool-size=1024
...
- wrk 测试
  ...
  Running 1m test @ http://10.138.0.3/api/v1/order/create
    8 threads and 2048 connections
    Thread Stats   Avg      Stdev     Max   +/- Stdev
      Latency     4.72s     7.23s   29.91s    85.32%
      Req/Sec   257.88    316.58     1.77k    87.27%
    Latency Distribution
       50%    1.31s
       75%    6.08s
       90%   17.22s
       99%   27.74s
    47414 requests in 1.00m, 11.49MB read
    Socket errors: connect 0, read 0, write 0, timeout 640
  Requests/sec:    788.96
  Transfer/sec:    195.77KB
  ```
...
- 水平分库和分表能够很好地扩展读性能，但不知为何写性能无法扩展并且很差。
