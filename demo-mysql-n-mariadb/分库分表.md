...
>`todo` 借助本站 [示例](https://gitee.com/dexterleslie/demonstration/tree/main/demo-mysql-n-mariadb/demo-order-management-app-sharding-jdbc) 测试此场景，但是 t_order 表在 in 查询两个订单 ID 时数据源和物理表的 `ShardingAlgorithm` 会发生迪卡尔积，性能很差。
