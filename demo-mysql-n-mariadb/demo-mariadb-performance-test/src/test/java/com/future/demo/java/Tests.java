...
@Measurement(iterations = 5, time = 300, timeUnit = TimeUnit.SECONDS) //测试也是1s、五遍
// 指定并发执行线程数
...
//    @Benchmark
//    public void testList(Blackhole blackhole) throws BusinessException {
//        int randomIndex = random.nextInt(userIdList.size());
//        Long userId = userIdList.get(randomIndex);
...
//        PageResponse<OperationLogService.OperationLogVo> voPageResponse =
//                this.operationLogService.list(userId, operationTypeList, randomPage, randomSize);
//        blackhole.consume(voPageResponse);
//    }
