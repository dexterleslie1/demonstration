...
1. 运行 [demo-performance-mybatis-plus-assistant](https://gitee.com/dexterleslie/demonstration/tree/master/demo-mysql-n-mariadb/demo-performance-mybatis-plus-assistant) 项目，协助模拟分析`MySQL cpu`使用率高情况
