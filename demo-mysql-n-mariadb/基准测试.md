...
- wrk 测试
  ...
  Running 15s test @ http://192.168.1.185/api/v1/order/getById
    8 threads and 2048 connections
    Thread Stats   Avg      Stdev     Max   +/- Stdev
      Latency    53.60ms   54.66ms 682.81ms   85.38%
      Req/Sec     3.98k   342.08     5.25k    68.92%
    Latency Distribution
       50%   43.80ms
       75%   78.54ms
       90%  125.04ms
       99%  235.62ms
    475642 requests in 15.05s, 265.11MB read
  Requests/sec:  31604.13
...
- wrk 测试
  ...
  Running 15s test @ http://192.168.1.185/api/v1/order/getById
    8 threads and 2048 connections
    Thread Stats   Avg      Stdev     Max   +/- Stdev
      Latency    66.89ms   61.40ms 700.92ms   63.49%
      Req/Sec     4.40k   293.60     5.49k    72.25%
    Latency Distribution
       50%   57.38ms
       75%   93.63ms
       90%  145.61ms
       99%  266.30ms
    525902 requests in 15.05s, 293.12MB read
  Requests/sec:  34951.20
...
- wrk 测试
  ...
  Running 15s test @ http://192.168.1.185/api/v1/order/getById
    8 threads and 2048 connections
    Thread Stats   Avg      Stdev     Max   +/- Stdev
      Latency    67.41ms   61.58ms 717.78ms   63.56%
      Req/Sec     4.39k   290.57     7.15k    71.17%
    Latency Distribution
       50%   58.18ms
       75%   94.37ms
       90%  146.46ms
       99%  265.50ms
    524171 requests in 15.04s, 305.28MB read
  Requests/sec:  34840.52
...
- wrk 测试
  ...
  Running 1m test @ http://192.168.1.185/api/v1/order/getById
    8 threads and 2048 connections
    Thread Stats   Avg      Stdev     Max   +/- Stdev
      Latency    73.14ms   66.77ms 767.95ms   63.55%
      Req/Sec     4.10k   316.91     5.20k    69.60%
    Latency Distribution
       50%   62.18ms
       75%  105.47ms
       90%  159.19ms
       99%  291.37ms
    1957123 requests in 1.00m, 1.18GB read
  Requests/sec:  32586.12
...
- 插入性能：bigint 和 int 主键类型时的插入性能较好，decimal 主键类型时的插入性能中等，varchar 主键类型时的插入性能较差。
