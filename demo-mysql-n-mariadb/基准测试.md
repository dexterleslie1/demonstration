...
```sh
wrk -t4 -c256 -d30s --latency --timeout 30 http://192.168.1.185/api/v1/demo/addProduct
...
```sh
# 商品扣减库存业务
wrk -t8 -c2048 -d3000000s --latency --timeout 30 http://192.168.1.185/api/v1/demo/decreaseProductStockAmount
