...
```bash
git clone https://gitee.com/dexterleslie/wrk2
```
...
```sh
wrk2 --rate 10 -t4 -c16 -d120s --latency --timeout 60 http://192.168.1.181:8080/api/v1/order/addOrdinaryProduct
```
...
参考本站[链接](/benchmark/gatling.html)
