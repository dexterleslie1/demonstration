...
2. 运行基准测试
   ...
   ```bash
   $ redis-benchmark -q -t set -r 1 -n 1000000 -p 6380 --cluster
   Cluster has 3 master nodes:
   
   Master 0: fa65b7efeb413617230c088ccf59195303133bd0 127.0.0.1:6382
   Master 1: c5d52eb63fbc3a0335c43e847811125115ed726d 127.0.0.1:6381
   Master 2: 2f65a603493893fd5cadc655fe89c08d20bb8257 127.0.0.1:6380
   
   SET: 284900.28 requests per second, p50=0.095 msec
   ```
