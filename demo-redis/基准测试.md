...
3. 使用 ClusterSSH 建立多个连接到压力机以同时执行多个 redis-benchmark 客户端
   ...
   $ redis-benchmark -q -t set -r 1 -n 1000000 -c 128 --threads 8 -h 192.168.1.185 -p 6379 -a 123456
...
3. 使用 ClusterSSH 建立多个连接到压力机以同时执行多个 redis-benchmark 客户端
   ...
   # 建立多个 cssh 连接后同时运行 redis-benchmark 客户端
   $ redis-benchmark -q -t set -r 1 -n 1000000 -c 128 --threads 8 -h 192.168.1.185 -p 6380 --cluster
