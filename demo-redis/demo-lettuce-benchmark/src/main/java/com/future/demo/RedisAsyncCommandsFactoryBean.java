...
@Component
public class RedisAsyncCommandsFactoryBean implements FactoryBean<RedisClusterAsyncCommands<String, String>>, DisposableBean {
    ...
    @Override
    public RedisClusterAsyncCommands<String, String> getObject() {
        if (StringUtils.hasText(this.springRedisHost)) {
            ...
            redisCommands = ((StatefulRedisConnection<String, String>) connection).async();
        } else {
            ...
            connection = client.connect();
            redisCommands = ((StatefulRedisClusterConnection<String, String>) connection).async();
        }
    ...
    public Class<?> getObjectType() {
        return RedisClusterAsyncCommands.class;
    }
