...
## 第三方控件 - vue-treeselect

>说明：在Vue2项目中使用，Vue3项目ElementPlus有TreeSelect组件替代。
>
>详细用法请参考本站示例：https://gitee.com/dexterleslie/demonstration/tree/main/front-end/library/vue2-treeselector
>
>GitHub地址：https://github.com/riophae/vue-treeselect
>
>官方参考文档：https://vue-treeselect.js.org/
...
>详细用法请参考本站示例：https://gitee.com/dexterleslie/demonstration/tree/main/front-end/demo-vue/demo-vue2-style-lang
...
LessDemo.vue使用less语法创建样式

```vue
<template>
  <div class="less-demo">
    <h2>Less 样式演示</h2>
    <p>这是一个使用 Less 样式的简单演示，展示了 Less 的特性。</p>
    
    <div class="less-features">
      <div class="feature">
        <h3>变量</h3>
      ...
      <div class="feature">
        <h3>混合</h3>
        <button class="btn-less primary">主要按钮</button>
        <button class="btn-less secondary">次要按钮</button>
      </div>
      
      <div class="feature">
        <h3>函数</h3>
        <div class="alert">普通提示</div>
...
// 定义变量
@less-primary-color: #42b983;
@less-secondary-color: #e74c3c;
@less-bg-color: #f8f9fa;
@less-border-radius: 10px;
@less-spacing: 20px;
@less-font-family: 'Arial', sans-serif;
...
.box-shadow(@offset: 0 2px 8px rgba(0, 0, 0, 0.1)) {
  box-shadow: @offset;
  transition: box-shadow 0.3s ease;
}

.btn-style(@color: @less-primary-color) {
  background-color: @color;
  color: white;
  border: none;
  padding: 10px 20px;
  border-radius: @less-border-radius;
  cursor: pointer;
  font-size: 1em;
...
// 主要样式
.less-demo {
  background-color: @less-bg-color;
  border-radius: @less-border-radius;
  padding: @less-spacing * 2;
  margin: @less-spacing auto;
  max-width: 800px;
  font-family: @less-font-family;
  .box-shadow();
  
  h2 {
    color: @less-primary-color;
    text-align: center;
...
.less-features {
  ...
  gap: @less-spacing;
  margin-top: @less-spacing * 2;
  
  .feature {
    background-color: white;
    padding: @less-spacing;
    border-radius: @less-border-radius;
    .box-shadow();
...
.color-box {
  ...
  height: 80px;
  border-radius: @less-border-radius;
  margin: 0 auto @less-spacing;
  .box-shadow();
  
  &.primary {
    background-color: @less-primary-color;
  }
  
  &.secondary {
    background-color: @less-secondary-color;
  }
}
...
.nested-example {
  .level-1 {
    background-color: lighten(@less-primary-color, 30%);
    padding: @less-spacing;
    border-radius: @less-border-radius;
    
    .level-2 {
      background-color: lighten(@less-primary-color, 20%);
      padding: @less-spacing;
      border-radius: @less-border-radius;
...
.btn-less {
  ...
  &.secondary {
    .btn-style(@less-secondary-color);
  }
}
...
.alert {
  ...
  &.success {
    background-color: lighten(@less-primary-color, 10%);
    color: darken(@less-primary-color, 30%);
  }
...
ScssDemo.vue使用scss语法创建样式

```vue
<template>
  <div class="scss-demo">
    <h2>SCSS 样式演示</h2>
    <p>这是一个使用 SCSS 样式的简单演示，展示了 SCSS 的特性。</p>
    
    <div class="scss-features">
      <div class="feature">
        <h3>变量</h3>
        <div class="color-box primary"></div>
        <div class="color-box secondary"></div>
      ...
      <div class="feature">
        <h3>混合宏</h3>
        <button class="btn-scss primary">主要按钮</button>
        <button class="btn-scss secondary">次要按钮</button>
      </div>
...
$scss-secondary-color: #e74c3c;
$scss-bg-color: #f8f9fa;
$scss-border-radius: 10px;
$scss-spacing: 20px;
$scss-font-family: 'Arial', sans-serif;
...
@mixin box-shadow($offset: 0 2px 8px rgba(0, 0, 0, 0.1)) {
  box-shadow: $offset;
  transition: box-shadow 0.3s ease;
}

@mixin btn-style($color: $scss-primary-color) {
  background-color: $color;
  color: white;
  border: none;
  padding: 10px 20px;
...
// 主要样式
.scss-demo {
  background-color: $scss-bg-color;
  border-radius: $scss-border-radius;
  padding: $scss-spacing * 2;
  margin: $scss-spacing auto;
  max-width: 800px;
  font-family: $scss-font-family;
  @include box-shadow;
  
  h2 {
    color: $scss-primary-color;
    text-align: center;
    margin-bottom: $scss-spacing;
    font-size: 2em;
  }
...
.color-box {
  ...
  &.secondary {
    background-color: $scss-secondary-color;
  }
}
...
.nested-example {
  .level-1 {
    background-color: lighten($scss-primary-color, 30%);
    padding: $scss-spacing;
    border-radius: $scss-border-radius;
    
    .level-2 {
      background-color: lighten($scss-primary-color, 20%);
      padding: $scss-spacing;
      border-radius: $scss-border-radius;
...
.btn-scss {
  ...
  &.secondary {
    @include btn-style($scss-secondary-color);
  }
}
