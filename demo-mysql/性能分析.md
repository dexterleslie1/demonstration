...
> todo 完善
>
> todo 怎么通过events_statements_summary_by_digest知道sql是否io慢呢？
...
1. 运行[demo-performance-mybatis-plus-assistant](https://github.com/dexterleslie1/demonstration/tree/master/demo-mysql/demo-performance-mybatis-plus-assistant)项目，协助模拟分析`MySQL cpu`使用率高情况
