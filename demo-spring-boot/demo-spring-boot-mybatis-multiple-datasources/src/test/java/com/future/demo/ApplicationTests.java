...
import com.future.demo.mapper2.EmployeeMapper2;
...
class ApplicationTests {
    ...
    void contextLoads() {
        ...
        // region 测试 EmployeeMapper2

        List<Employee> employeeList2 = this.employeeMapper2.listAll();
        Assertions.assertEquals(0, employeeList2.size());
